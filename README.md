...
- Nếu đặt link ủng hộ, hãy thay `href="#"` trong `app.js` bằng địa chỉ hợp lệ.
- Không nên kêu gọi người dùng click quảng cáo. Nếu sau này có quảng cáo, cần tuân thủ chính sách của nền tảng quảng cáo và ưu tiên trải nghiệm người học.
